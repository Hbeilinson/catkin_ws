#include<custom_layers/custom_layer.h>
#include <pluginlib/class_list_macros.h>

PLUGINLIB_EXPORT_CLASS(simple_layer_namespace::CustomLayer, costmap_2d::Layer)
...
void CustomLayer::updateBounds(double robot_x, double robot_y, double robot_yaw, double* min_x,
